...
<div class="w-full min-h-[100vh] py-10 px-2 bg-brand-50">
	<div class="max-w-[770px] w-full mx-auto">
		<h1 class="mb-10 text-4xl font-bold text-black">Almost Casino</h1>

		<p class="mb-8 text-lg text-brand-700">
			Welcome to Almost Casino! This is as fake casino as possible. No worries, it's all virtual and
			no real money is involved.
		</p>

		<p class="mb-8 text-lg text-brand-700">
			Almost Casino was created as a project to showcase how well <a
